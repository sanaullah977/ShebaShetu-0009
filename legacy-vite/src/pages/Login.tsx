...
const ROLES: { id: Role; label: string; sub: string; icon: typeof UserRound; route: string; tint: string }[] = [
  { id: "patient",   label: "Patient",   sub: "Book, queue & track visits",  icon: UserRound,     route: "/patient",   tint: "from-emerald-500/20 to-emerald-500/5" },
  { id: "reception", label: "Reception", sub: "Manage queues & schedules",   icon: ClipboardList, route: "/reception", tint: "from-orange-400/20 to-orange-400/5" },
  { id: "doctor",    label: "Doctor",    sub: "See patients & reports",      icon: Stethoscope,   route: "/doctor",    tint: "from-sky-400/20 to-sky-400/5" },
];
            ...
            <form onSubmit={handleContinue} className="space-y-4">
              {mode === "register" && (
                <div className="space-y-1.5">
                  ...
                  <Input id="name" placeholder="Nadia Ahmed" defaultValue="Nadia Ahmed" />
                </div>
              )}
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="email" className="pl-9" placeholder="you@example.com" defaultValue="nadia@example.com" />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" className="pl-9" placeholder="••••••••" defaultValue="demo1234" />
                </div>
              </div>

              <Button type="submit" size="lg" className="w-full bg-gradient-emerald text-primary-foreground font-semibold hover:opacity-95 shadow-glow">
