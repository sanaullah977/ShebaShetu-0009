...
const PATIENT: Item[] = [
  ...
  { to: "/patient/symptom",    label: "AI Symptom",    icon: Sparkles },
  { to: "/patient/book",       label: "Book Visit",    icon: CalendarDays },
...
const DOCTOR: Item[] = [
  { to: "/doctor",             label: "Today's List",  icon: ClipboardList },
