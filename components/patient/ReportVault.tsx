  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {filtered.length > 0 ? (
          filtered.map((report) => (
            <GlassCard key={report.id} className="group hover:ring-1 hover:ring-primary/40 transition-all duration-300 p-0 overflow-hidden flex flex-col">
              <div className="p-5 space-y-4 flex-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground truncate font-mono">{report.fileName}</p>
                </div>
